...
draghi_statements_data = pl.DataFrame(data)
...
parsed_dates = draghi_statements_data.with_columns(date = pl.col('date').map_elements(lambda x: replace_italian_months(x)))
...
parsed_dates.write_csv("data/draghi_statements.csv")
